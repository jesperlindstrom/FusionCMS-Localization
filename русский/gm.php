...
$lang['invalid'] = "Неправильные значения";
$lang['message_too_long'] = "Сообщение слишком длинное. Нужно не более 8000 символов.";
...
$lang['close_ticket'] = "Вы действительно хотите закрыть этот тикет?";
$lang['close_short'] = "Закрыть";
$lang['ban_short'] = "Забанить";
$lang['kick_short'] = "Кикнуть";
$lang['send'] = "Отправить";
$lang['mail_sent'] = "Письмо было отправлено";
$lang['teleported'] = "Персонаж был телепортнут";
$lang['must_be_offline'] = "Персонаж должен быть вне игре";
$lang['item_sent'] = "Предмет был отправлено";